...
export class Backend implements backendInterface {
    ...
    async addFunFact(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addFunFact(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addMemory(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getRandomFunFact(): Promise<string> {
        if (this.processError) {
            try {
    ...
    async isCodeCorrect(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isCodeCorrect(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
