...
const SAMPLE_MEMORIES = [
  {
    ...
    content: 'I still remember the first time we laughed so hard together that tears rolled down our cheeks. That moment felt like magic — like Doraemon had pulled out a "Laughter Gadget" just for us. It was the beginning of something beautiful.',
    date: '2024-01-15',
  },
  {
    id: 'mem-2',
    title: 'Our Secret Language 🌟',
    content: 'We developed our own little language — inside jokes, secret signals, and words only we understand. Just like Nobita and Doraemon have their own world, we built ours. And it\'s the most precious place I know.',
    date: '2024-03-22',
  },
  {
    id: 'mem-3',
    title: 'The Night We Watched Stars 🌌',
    content: 'Remember when we stayed up late just talking about everything and nothing? The stars were our audience, and the night felt endless. I felt like we were in our own Doraemon episode — magical and timeless.',
    date: '2024-05-10',
  },
  {
    id: 'mem-4',
    title: 'When You Made Everything Better 💙',
    content: 'There was a day when everything felt heavy and wrong. And then you appeared — with your smile, your words, your presence. Like Doraemon appearing from the future with exactly the right gadget, you fixed everything just by being you.',
    date: '2024-07-04',
  },
  {
    id: 'mem-5',
    title: 'Our Doraemon Marathon 🎬',
    content: 'We watched Doraemon episodes together and I realized — we ARE Nobita and Doraemon. Different, yet perfectly matched. You bring out the best in me, just like Doraemon does for Nobita. This memory lives in my heart forever.',
    date: '2024-09-18',
  },
  {
    id: 'mem-6',
    title: 'The Promise We Made 🤝',
    content: 'We made a promise — to always be there for each other, no matter what. Like the unbreakable bond between Nobita and Doraemon that transcends time itself. That promise is my most treasured gadget.',
    date: '2024-11-30',
  },
];
...
const SAMPLE_QUOTES = [
  ...
  { author: 'Nobita', text: 'Even if I fail a hundred times, I\'ll try a hundred and one.' },
  { author: 'Doraemon', text: 'A true friend is someone who knows all about you and still loves you.' },
  { author: 'Shizuka', text: 'Kindness is the language which the deaf can hear and the blind can see.' },
  { author: 'Doraemon', text: 'Don\'t worry about tomorrow. Today is what matters.' },
  { author: 'Nobita', text: 'I may not be the smartest, but I have the biggest heart.' },
  { author: 'Doraemon', text: 'Every problem has a solution. You just need to look in the right pocket.' },
  { author: 'Doraemon', text: 'Friendship is the greatest gadget in the universe.' },
  { author: 'Nobita', text: 'With a friend like you, I can face anything.' },
  { author: 'Doraemon', text: 'The most important thing is not what you have, but who you have beside you.' },
  { author: 'Shizuka', text: 'True strength comes from the heart, not from gadgets.' },
  { author: 'Doraemon', text: 'Even the smallest dream is worth chasing.' },
  { author: 'Nobita', text: 'I believe in miracles because I have you.' },
  { author: 'Doraemon', text: 'Love and friendship are the only gadgets that never run out of power.' },
  { author: 'Doraemon', text: 'Time may pass, but true bonds only grow stronger.' },
  { author: 'Nobita', text: 'You make every ordinary day feel like an adventure.' },
